...
void module::read_module(struct t_module *tmodule, QString addressModule){
    ...
    strcpy(tmodule->input_a1, sett.value("INPUT_A1").toString().toLatin1());
    strcpy(tmodule->input_a2, sett.value("INPUT_A2").toString().toLatin1());
    strcpy(tmodule->input_a3, sett.value("INPUT_A3").toString().toLatin1());
    strcpy(tmodule->input_a4, sett.value("INPUT_A4").toString().toLatin1());
    strcpy(tmodule->input_a5, sett.value("INPUT_A5").toString().toLatin1());
    strcpy(tmodule->input_a6, sett.value("INPUT_A6").toString().toLatin1());

    strcpy(tmodule->input_d1, sett.value("INPUT_D1").toString().toLatin1());
    strcpy(tmodule->input_d2, sett.value("INPUT_D2").toString().toLatin1());
    strcpy(tmodule->input_d3, sett.value("INPUT_D3").toString().toLatin1());
    strcpy(tmodule->input_d4, sett.value("INPUT_D4").toString().toLatin1());
    strcpy(tmodule->input_d5, sett.value("INPUT_D5").toString().toLatin1());
    strcpy(tmodule->input_d6, sett.value("INPUT_D6").toString().toLatin1());
    strcpy(tmodule->input_d7, sett.value("INPUT_D7").toString().toLatin1());
    strcpy(tmodule->input_d8, sett.value("INPUT_D8").toString().toLatin1());

    strcpy(tmodule->output_r1, sett.value("OUTPUT_R1").toString().toLatin1());
    strcpy(tmodule->output_r2, sett.value("OUTPUT_R2").toString().toLatin1());
    strcpy(tmodule->output_r3, sett.value("OUTPUT_R3").toString().toLatin1());
    strcpy(tmodule->output_r4, sett.value("OUTPUT_R4").toString().toLatin1());
